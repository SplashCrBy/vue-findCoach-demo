<!--
 * @Author: Sizhao Li
 * @Date: 2020-12-04 16:16:14
 * @LastEditors: Sizhao Li
 * @LastEditTime: 2020-12-04 17:33:14
...
<template>
  <form @submit.prevent="submitForm">
    ...
    <div class="form-control" :class="{ invalid: !description.isValid }">
      ...
      <input type="text" id="Description" row="5" v-model.trim="description.val" @blur="clearValidity('description')" />
      <p v-if="!description.isValid">description should not be empty!</p>
    </div>
    <div class="form-control" :class="{ invalid: !rate.isValid }">
      <label for="rate">rate</label>
      <input type="number" id="rate" v-model.number="rate.val" @blur="clearValidity('rate')" />
      <p v-if="!rate.isValid">rate should be greater than zero!</p>
    </div>
    <div class="form-control" :class="{ invalid: !areas.isValid }">
      ...
      <p v-if="!areas.isValid">areas should not be empty!</p>
    </div>
